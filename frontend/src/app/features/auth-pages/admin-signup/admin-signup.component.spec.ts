...
describe('AdminSignupComponent', () => {
  ...
  describe('Form Validation', () => {
    it('should initialize form with empty values', () => {
      expect(component.adminSignupForm.value).toEqual({
        username: '',
        email: '',
        password: '',
      });
    ...
    it('should validate username field', () => {
      const username = component.adminSignupForm.controls.username;
    ...
    it('should validate email field', () => {
      const email = component.adminSignupForm.controls.email;
    ...
    it('should validate password field', () => {
      const password = component.adminSignupForm.controls.password;
  ...
  describe('onSubmit()', () => {
    ...
    it('should not call signup service when form is invalid', () => {
      ...
      expect(mockRegisterService.adminSignup).not.toHaveBeenCalled();
    ...
    it('should call signup service when form is valid', () => {
      component.adminSignupForm.setValue(validFormData);
      mockRegisterService.adminSignup.and.returnValue(of({}));

      component.onSubmit();

      expect(mockRegisterService.adminSignup).toHaveBeenCalledWith(
        validFormData
      );
    });
    ...
    it('should handle successful signup', () => {
      ...
      component.adminSignupForm.setValue(validFormData);
      mockRegisterService.adminSignup.and.returnValue(
  ...
  describe('UI Interactions', () => {
    ...
    it('should show validation messages when fields are invalid and touched', () => {
      const emailControl = component.adminSignupForm.controls.email;
